            ...
            <div class="row justify-content-md-center">
                <div class="col input-group mb-3 justify-content-md-center">
                    <select class="form-select" name="proxycfg" aria-label="themex">
                        <option selected>Select a proxy</option>
    ...
    <div class="container mb-3">
        <form action="proxyconf.php" method="post">
            <div class="container text-center justify-content-md-center">
                ...
                <div class="row justify-content-md-center">
                    <div class="col input-group mb-3 justify-content-md-center">
                        <input class="btn btn-info" type="submit" value="Save Agent">
                    </div>
                </div>
                <div class="row justify-content-md-center">
                    <div class="col input-group mb-3 justify-content-md-center">
                        <?php if (!empty($strNewProxy)) echo "<h5>Proxy modification successful</h5>"; ?>
                    </div>
                </div>
            </div>
        </form>   
