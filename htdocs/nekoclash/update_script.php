...
if (!file_exists($local_api_response)) {
    die("Unable to access the GitHub API. Please check the URL or network connection.");
}
...
if (empty($new_version)) {
    die("The latest version was not found or the version information is empty.");
}
