...
function formatFileModificationTime($filePath) {
    if (file_exists($filePath)) {
        ...
        return date('Ymd H:i:s', $fileModTime);
    } else {
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($input)) {
        ...
        echo "<h2 style=\"color: #00FFFF;\">Conversion completed</h2>";
        echo "<p>The configuration file has been successfully saved to <strong>$file_path</strong></p>";
                    ...
                    <li class="list-group-item">
                        ...
                        <div class="button-group">
                            ...
                            <form action="" method="post">
                                ...
                                <input type="text" name="newFileName" class="form-control form-control-sm" placeholder="newFileName" required>
...
<div class="navigation">
    <a href="javascript:history.back()" class="btn">Return to the previous menu</a>
    ...
    <a href="/nekoclash" class="btn">Return to the main menu</a>
</div>
        <section id="custom-dir-upload" class="section-gap">
            ...
            <?php if (isset($fileContent)): ?>
                ...
                <p>Last updated date: <?php echo date('Ymd H:i:s', filemtime($fileToEdit)); ?></p>
                <form action="" method="post">
        ...
        <section id="subscription-management" class="section-gap">
            <h2 class="text-success">Subscription Management</h2>
                <p class="help-text" style="text-align: left; font-family: Arial, sans-serif; line-height: 1.5; font-size: 14px;">
                    <strong>1. Note:</strong> The general template (<code>tuanbe.yaml</code>) supports up to <strong>7</strong> subscription links. Please do not change the default name.
                </p>

                <p class="help-text" style="text-align: left; font-family: Arial, sans-serif; line-height: 1.5; font-size: 14px;">
                    <strong>2. Save and Update:</strong> After filling in the information, please click the "Update Configuration" button to save it.
                </p>

                <p class="help-text" style="text-align: left; font-family: Arial, sans-serif; line-height: 1.5; font-size: 14px;">
                    <strong>3. Node conversion and manual modification:</strong> This template supports subscription links of all formats without the need for additional conversion. A single node can be converted using the node conversion tool below and automatically saved as a proxy. You can also manually modify the proxy directory file and add it in the form of a node link.
                </p>
